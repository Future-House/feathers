...
function Collapsible(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(CollapsiblePrimitive.Root, _objectSpread({
...
function CollapsibleTrigger(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(CollapsiblePrimitive.CollapsibleTrigger, _objectSpread({
...
function CollapsibleContent(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(CollapsiblePrimitive.CollapsibleContent, _objectSpread({
