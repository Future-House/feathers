...
function Popover(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(PopoverPrimitive.Root, _objectSpread({
      "data-slot": "popover"
    }, props));
    $[2] = props;
    $[3] = t1;
...
function PopoverTrigger(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(PopoverPrimitive.Trigger, _objectSpread({
...
function PopoverContent(t0) {
  ...
  if ($[7] !== align || $[8] !== props || $[9] !== sideOffset || $[10] !== t3) {
    t4 = /*#__PURE__*/_jsx(PopoverPrimitive.Portal, {
...
function PopoverAnchor(t0) {
  ...
  var t1;
  if ($[2] !== props) {
    t1 = /*#__PURE__*/_jsx(PopoverPrimitive.Anchor, _objectSpread({
