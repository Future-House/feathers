  ...
  {[
    ...
    },
    {
      ...
      colors: [
        ...
        { name: 'Accent', class: 'bg-accent', cssVar: '--accent', desc: 'Accent background color' },
    ...
    <div key={section.category} className="sb-unstyled mb-6">
      <h3 className="sb-unstyled text-xl font-semibold mb-2">{section.category}</h3>
...
<div className="my-8">
  <h3 className="sb-unstyled text-xl font-semibold mb-4">Sidebar Component Colors</h3>
...
<div className="my-8">
  <p className="sb-unstyled text-muted-foreground mb-6">In addition to our semantic colors, Feathers includes access to [Tailwind's full color palette](https://tailwindcss.com/docs/colors) for additional flexibility.</p>
