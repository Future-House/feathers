...
export const typographyStyles = {
    h1: { size: '3.25rem', weight: 'normal', lineHeight: '115%', spacing: percentageToRem(-2.5), family: 'Noto Sans' },
    h2: { size: '2.5rem', weight: 'normal', lineHeight: '115%', spacing: percentageToRem(-2.5), family: 'Noto Sans' },
    h3: { size: '1.875rem', weight: 'normal', lineHeight: '125%', spacing: percentageToRem(-2.5), family: 'Noto Sans' },
    h4: { size: '1.5rem', weight: 'normal', lineHeight: '130%', spacing: percentageToRem(-2.5), family: 'Noto Sans' },
    'p-large': { size: '1.125rem', weight: 'normal', lineHeight: '153%', spacing: percentageToRem(-2.5), family: 'Noto Sans' },
    'p-medium': { size: '1.0rem', weight: 'normal', lineHeight: '160%', spacing: percentageToRem(-2), family: 'Noto Sans' },
    'p-small': { size: '0.9rem', weight: 'normal', lineHeight: '160%', spacing: percentageToRem(0), family: 'Noto Sans' },
