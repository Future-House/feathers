...
const Typeahead = forwardRef(({
    ...
    const [selectedStr, setSelectedStr] = useState(value || '');
    ...
    useEffect(() => {
        const scrollToSelectedItem = () => {
            const selectedIndex = options.indexOf(selectedStr);
