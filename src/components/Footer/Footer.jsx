import { ButtonGroup, IconButton, Stack, chakra, useColorMode, Box } from '@chakra-ui/react';
        ...
        <Box bg="bg.accent.default" color="fg.accent.default" {...rest}>
            {(showCareerOpportunities || enableScrollToTop) && (
                <Box sx={{ display: 'flex', alignItems: 'baseline', padding: '.5rem' }}>
                    ...
                    {enableScrollToTop && showCareerOpportunities && (
                        " | "
                    )}
                    {showCareerOpportunities && (
                        <StyledLink href="https://job-boards.greenhouse.io/futurehouse" target="_blank">
