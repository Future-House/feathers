...
<SubcomponentPropTable
  subcomponents={AlertDialogStories.default.subcomponents}
/>
...
<Canvas of={AlertDialogStories.WithoutDescription} />

### Long Content

Alert dialog with scrollable content for longer text.

<Canvas of={AlertDialogStories.LongContent} />

### Custom Styling

Customize the appearance with custom colors and gradients.

<Canvas of={AlertDialogStories.CustomStyling} />
...
<Canvas of={AlertDialogStories.MultipleActions} />

### With Form

Include form elements within the alert dialog.

<Canvas of={AlertDialogStories.WithForm} />

### Accessibility Features

Demonstrates accessibility features and proper ARIA attributes.

<Canvas of={AlertDialogStories.AccessibilityExample} />
