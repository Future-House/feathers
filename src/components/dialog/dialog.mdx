...
<Canvas of={DialogStories.EditProfile} />
...
<Canvas of={DialogStories.NewsletterSignup} />

### Success Message

A centered success dialog with positive feedback.

<Canvas of={DialogStories.SuccessMessage} />

### Settings Dialog

A complex settings dialog with multiple sections and scroll support.

<Canvas of={DialogStories.SettingsDialog} />
