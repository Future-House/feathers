...
<DocLayout meta={DrawerStories.default} hideRadixUiUrl>
...
You may need to reference the official documentation for the [Vaul](https://vaul.emilkowal.ski/getting-started) to understand the full API and available options.

<PropsTable argTypes={DrawerStories.default.argTypes} />

<SubcomponentPropTable subcomponents={DrawerStories.default.subcomponents} />
